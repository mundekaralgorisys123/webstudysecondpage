...
async def handle_michaelhill(url, max_pages):
        ...
        while load_more_clicks <= max_pages:
            async with async_playwright() as p:
                ...
                for _ in range(load_more_clicks - 1):
                    try:
                        load_more_button = page.locator("button.o-button.o-button--primary.u-accessibility[data-v-77d5b144]")
                ...
                for idx, product in enumerate(new_products):
                    try:
                        product_name_tag = await product.query_selector("a.product-tile__title")
                    ...
                    try:
                        ...
                        image_url = await image_div.get_attribute("images") if image_div else "N/A"
                    except Exception as e:
